(function() {
	...
	appsCtrl.$inject = ['sampleService','authService','$state','$http','toastr','$rootScope','navService']

	function appsCtrl(sampleService,authService,$state, $http, toastr, $rootScope, navService) {
